...
class CreditCardWidget(QFrame):
    ...
    def setup_ui(self):
        ...
        header.setStyleSheet("color: #9333ea; border: none; padding: 0; margin-bottom: 10px;")
        layout.addWidget(header)
        
        # Balance Overview
        balance_frame = QFrame()
        balance_frame.setStyleSheet("QFrame { background-color: #1a202c; border: 1px solid #4a5568; border-radius: 8px; padding: 15px; }")
        ...
        balance_label.setStyleSheet("color: white; font-weight: bold; border: none; padding: 0;")
        ...
        util_label.setStyleSheet("color: white; border: none; padding: 0; margin-top: 10px;")
        ...
        self.utilization_status.setStyleSheet("color: #10b981; font-size: 12px; border: none; padding: 0; margin-top: 5px;")
        ...
        activity_frame.setStyleSheet("QFrame { background-color: #1a202c; border: 1px solid #4a5568; border-radius: 8px; padding: 15px; }")
        ...
        activity_title.setStyleSheet("color: #9333ea; border: none; padding: 0; margin-bottom: 10px;")
        ...
        self.charges_value.setStyleSheet("color: #ef4444; font-weight: bold; border: none; padding: 0;")
        ...
        self.payments_value.setStyleSheet("color: #10b981; font-weight: bold; border: none; padding: 0;")
        ...
        net_label.setStyleSheet("color: white; font-weight: bold; border: none; padding: 0; margin-top: 5px;")
        self.net_value = QLabel("$0.00")
        self.net_value.setStyleSheet("color: white; font-weight: bold; border: none; padding: 0; margin-top: 5px;")
        ...
        self.status_label.setStyleSheet("color: white; font-size: 12px; border: none; padding: 5px; margin-top: 10px;")
    ...
    def update_data(self, balance_owed, credit_limit=4000):
        ...
        if utilization < 10:
            ...
            self.utilization_status.setStyleSheet("color: #f59e0b; font-size: 12px; border: none; padding: 0; margin-top: 5px;")
            self.utilization_bar.setStyleSheet("""
                QProgressBar {
                    border: 2px solid #4a5568;
                    border-radius: 5px;
            ...
            self.utilization_status.setStyleSheet("color: #ef4444; font-size: 12px; border: none; padding: 0; margin-top: 5px;")
            self.utilization_bar.setStyleSheet("""
                QProgressBar {
                    border: 2px solid #4a5568;
                    border-radius: 5px;
    ...
    def update_monthly_activity(self, charges, payments):
        ...
        if net > 0:
            self.net_value.setStyleSheet("color: #ef4444; font-weight: bold; border: none; padding: 0; margin-top: 5px;")
        elif net < 0:
            self.net_value.setStyleSheet("color: #10b981; font-weight: bold; border: none; padding: 0; margin-top: 5px;")
        else:
            self.net_value.setStyleSheet("color: white; font-weight: bold; border: none; padding: 0; margin-top: 5px;")
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for tx in transactions:
                    ...
                    if tx_date >= month_start.strftime("%Y-%m-%d") and account == "credit":
                        if amount < 0:
                            charges += abs(amount)
    ...
    def show_status(self, message, color):
        ...
        self.status_label.setStyleSheet(f"color: {color}; font-size: 12px; border: none; padding: 5px; margin-top: 10px;")
