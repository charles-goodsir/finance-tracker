classification_rules = {
    "Groceries": ["pak n save", "pak'nsave", "new world", "countdown", "iga", "supervalue", "supermarket", "groceries"],
    "Transportation": ["uber", "taxi", "bp", "shell", "caltex", "fuel", "petrol"],
    "Bills & Utilities": ["electricity", "gas", "water", "internet", "telstra", "optus", "vodafone"],
    "Entertainment": ["netflix", "spotify", "disney", "cinema", "f1"],
    "Dining Out": ["restaurant", "cafe", "coffee", "pizza", "burger", "kfc", "mcdonalds", "subway"],
